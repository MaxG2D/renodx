// Sun Apr 14 19:19:00 2024
Texture2D<float4> t4 : register(t4); //RGB mask material properties

Texture2D<float4> t3 : register(t3); //Depth

Texture2D<float4> t2 : register(t2); //Empty

Texture2D<float4> t1 : register(t1); //Velocity
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r0.xy = -cb2[3].xy + v1.xy;				//DECLARE, DO NOT TOUCH
  r0.z = t3.Sample(s3_s, r0.xy).x;			//DECLARE, DO NOT TOUCH
  r1.xy = cb2[3].xy + v1.xy;				//DECLARE, DO NOT TOUCH
  r0.w = t3.Sample(s3_s, r1.xy).x;			//DECLARE, DO NOT TOUCH
  r2.xyzw = cb2[3].xyxy * float4(1,0,1,-1) + v1.xyxy;
  r1.z = t3.Sample(s3_s, r2.zw).x;			//DECLARE, DO NOT TOUCH
  r0.w = min(r1.z, r0.w);					
  r0.w = min(r0.z, r0.w);					
  r0.z = cmp(r0.w == r0.z);					
  r3.xy = r0.zz ? r0.xy : r1.xy;			
  r4.xyz = t0.Sample(s0_s, r0.xy).yxz;		//DECLARE, DO NOT TOUCH
  r5.xyz = t0.Sample(s0_s, r1.xy).yxz;		//DECLARE, DO NOT TOUCH
  r0.x = cmp(r0.w == r1.z);					//DECLARE, DO NOT TOUCH
  r0.xy = r0.xx ? r2.zw : r3.xy;			
  r1.xyzw = cb2[3].xyxy * float4(-1,1,0,-1) + v1.xyxy;	//Weird shit, some kind od luma prep?
  r0.z = t3.Sample(s3_s, r1.zw).x;			//DECLARE, DO NOT TOUCH
  r0.w = min(r0.z, r0.w);									
  r3.x = t3.Sample(s3_s, r2.xy).x;			//DECLARE, DO NOT TOUCH
  r0.w = min(r3.x, r0.w);					
  r3.x = cmp(r0.w == r3.x);					
  r0.xy = r3.xx ? r2.xy : r0.xy;			
  r0.z = cmp(r0.w == r0.z);					
  r0.xy = r0.zz ? r1.zw : r0.xy;			
  r3.xyzw = cb2[3].xyxy * float4(0,1,-1,0) + v1.xyxy; //Weird shit, some kind od luma prep?
  ...
  r1.x = cmp(r3.w < r6.x);
  r11.xyz = t0.Sample(s0_s, v1.xy).xyz;
  r12.x = dot(r11.yzx, float3(0.5,0.25,0.25));
  r3.x = cmp(r12.x < r6.x);
  r12.yz = r11.xz;
  ...
  r1.y = cmp(1 < r4.w);						
  r1.z = -r4.y * 0.25 + r4.w;				//Velocity/color mixing of sorts
  r1.z = -r4.z * 0.25 + r1.z;				//Velocity/color mixing of sorts
  r2.y = r1.z + r1.z;						//Velocity/color mixing of sorts
  r7.z = r4.x;								
  r2.xzw = r4.yzw;							//Velocity/color mixing of sorts
  r1.z = -r7.x * 0.25 + r7.w;				//Velocity/color mixing of sorts
  r1.z = -r4.x * 0.25 + r1.z;				//Velocity/color mixing of sorts
  r7.y = r1.z + r1.z;						//Velocity/color mixing of sorts
  r1.z = cmp(r7.w < 0);						
  r3.xyzw = r1.zzzz ? r2.xyzw : r7.xyzw;	//Velocity/color mixing of sorts
  r4.xyzw = r1.yyyy ? r3.xyzw : r2.xyzw;	//Velocity/color mixing of sorts
  r1.y = max(r6.x, r3.w);					//TAA edges clamp
  r5.x = min(r1.y, r4.w);					//TAA edges clamp
  r5.z = r4.w;								
  r5.y = r3.w;								
  r8.z = r2.w;								
  r8.x = r6.x;								
  ...
  o0.yzw = r6.yzw;							//DECLARE, DO NOT TOUCH
  r0.w = min(r0.w, r0.x);					
  r1.x = 0.99000001 + -r0.w;				
  r0.w = r6.y * r1.x + r0.w;				
  r1.x = r0.w * r0.z + r12.x;				
  r0.z = r0.w * r0.z;						
  r0.z = cmp(abs(r0.z) < 0.0099999978);		//Some kind of threshold, does not do much
  o0.x = saturate(r0.z ? r12.x : r1.x);			
  r1.xyw = r1.zzz ? r3.xyz : r7.xyz;		
  r2.xyz = r1.zzz ? r4.xyz : r2.xyz;		
  r2.xyz = r2.xyz + -r1.xyw;				//TAA Some kind of noise
  r0.z = cmp(0.00999999978 < r5.x);			//TAA Threshold?
  r1.z = r5.y / r5.x;						
  r0.z = r0.z ? r1.z : 0.5;					
  ...
  r3.xyz = r11.xyz + -r2.xyz;			// r3.xyz = r11.xyz + -r2.xyz;
  r0.xyz = r0.xxx * r3.xyz + r2.xyz;		
  r1.xyz = r1.xyz + -r0.xyz;				//CLAMP HERE, BUT r0 NEEDS FIXING, NOT REMOVAL
  r0.xyz = saturate(r0.www * r1.xyz + r0.xyz);	//TAA + color blend
