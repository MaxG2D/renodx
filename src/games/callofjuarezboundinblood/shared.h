...
struct ShaderInjectData {
  ...
  float custom_AA_blur_strength;
  float custom_bloom_radius;

  float custom_chromacity_effects_strength;
  float custom_bloom_amount;
  float custom_clouds_glow;
...
#define CUSTOM_BLOOM_AMOUNT                       shader_injection[8][1]
#define CUSTOM_CLOUDS_GLOW                        shader_injection[8][2]
#define CUSTOM_CLOUDS_GLOW_CONTRAST               shader_injection[8][3]
#define CUSTOM_CLOUDS_GLOW_SATURATION             shader_injection[9][0]
...
#define CUSTOM_CLOUDS_GLOW                        shader_injection.custom_clouds_glow
#define CUSTOM_CLOUDS_GLOW_CONTRAST               shader_injection.custom_clouds_glow_contrast
#define CUSTOM_CLOUDS_GLOW_SATURATION             shader_injection.custom_clouds_glow_saturation
